 ...
 * February 15, 2019
 */
#ifndef WCI_FRONTEND_CPP_TOKENS_PASCALSTRINGTOKEN_H_
#define WCI_FRONTEND_CPP_TOKENS_PASCALSTRINGTOKEN_H_
...
#endif /* WCI_FRONTEND_CPP_TOKENS_PASCALSTRINGTOKEN_H_ */
